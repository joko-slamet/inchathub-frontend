...
import type { SiteSettingDTO, SiteSettingInput } from "@/lib/site-settings-types";
...
export async function updateSiteSettings(input: SiteSettingInput): Promise<ActionResult<SiteSettingDTO[]>> {
  let token: string;
  try {
