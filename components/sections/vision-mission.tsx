  ...
  return (
    <section className="bg-paper px-6 py-20 sm:py-28 md:px-10 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:gap-16">
        <ScrollReveal>
          <div className="tilt-hover relative flex h-full flex-col justify-center overflow-hidden rounded-[2rem] border-2 border-signal/15 bg-signal-dim px-8 py-14 shadow-[0_20px_50px_-24px_rgba(190,30,45,0.35)] sm:px-10">
            <LuMountain
        ...
        <ScrollReveal delay={0.1}>
          ...
          <div className="mt-6 flex flex-col gap-3">
            {content.missionItems.map((item, index) => (
              <div
                key={item.textAccent}
                className="tilt-hover-r flex items-start gap-4 rounded-2xl border border-line bg-paper p-5 shadow-[0_14px_36px_-26px_rgba(26,22,24,0.3)]"
              >
