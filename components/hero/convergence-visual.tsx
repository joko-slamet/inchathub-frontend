...
const bubbleLayout = [
  { badge: "WA", className: "top-[2%] left-[-2%]", travel: { x: 78, y: 30 }, delay: 0 },
  { badge: "IG", className: "top-[0%] left-[36%]", travel: { x: 46, y: 44 }, delay: 0.7 },
  { badge: "TG", className: "top-[26%] left-[-6%]", travel: { x: 88, y: 8 }, delay: 1.4 },
  { badge: "MAIL", className: "top-[68%] left-[-4%]", travel: { x: 82, y: -22 }, delay: 2.1 },
  { badge: "FB", className: "top-[92%] left-[28%]", travel: { x: 54, y: -50 }, delay: 2.8 },
  { badge: "WEB", className: "top-[46%] left-[4%]", travel: { x: 70, y: 0 }, delay: 3.5 },
];
  ...
  return (
    ...
    >
      {bubbleLayout.map((bubble, index) => {
        const channel = channels.find((c) => c.badge === bubble.badge);
