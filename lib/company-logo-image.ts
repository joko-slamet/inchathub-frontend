// CompanyLogo.imageUrl from the backend is just a relative path (e.g.
// "/uploads/logos/x.png") — the backend never bakes in a host, since that
...
// at.
export function toCompanyLogoImageUrl(imageUrl: string): string {
