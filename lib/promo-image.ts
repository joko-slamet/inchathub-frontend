// Promo.imageUrl from the backend is just a relative path (e.g.
// "/uploads/promos/x.png") — the backend never bakes in a host, since that
...
// at.
export function toPromoImageUrl(imageUrl: string): string {
