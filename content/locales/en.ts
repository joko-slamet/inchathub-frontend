...
export const en: SiteContent = {
  ...
  omnichannel: {
    ...
    impact: [
      ...
      { label: "A Better Customer Experience" },
  ...
  aiCrm: {
    ...
    chatbot: {
      ...
      points: [
        ...
        { title: "Human Handoff", description: "Conversations that need a personal touch are automatically routed to the right agent." },
      ],
    },
    crm: {
      title: "Smart CRM",
    ...
    pipeline: {
      ...
      stages: [
        { name: "New", deals: [{ name: "Berkah Jaya Store", value: "$280" }, { name: "Mitra Abadi Co.", value: "$570" }] },
        { name: "Follow-up", deals: [{ name: "Sehat Sentosa Clinic", value: "$800" }] },
        { name: "Negotiation", deals: [{ name: "Sejahtera Cooperative", value: "$1,400" }, { name: "Nusantara Boga Ltd.", value: "$1,000" }] },
        { name: "Won", deals: [{ name: "Pelita Bangsa School", value: "$2,000" }] },
      ],
    },
  },
  ...
  industries: {
    ...
    logoStripLabel: "Trusted by organizations including",
    logoPlaceholderText: "Client Logo",
  },
